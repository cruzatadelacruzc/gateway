    ...
    public boolean shouldFilter() {
        ...
        for (Route route : routeLocator.getRoutes()) {
            ...
            if (requestUri.startsWith(serviceUrl.substring(0, serviceUrl.length() - 2))) {
                return !isAuthorizedRequest(serviceName, serviceUrl, requestUri);
            }
        }
        return false;
    }

    private boolean isAuthorizedRequest(String serviceName, String serviceUrl, String requestUri) {
        Map<String, List<String>> authorizedMicroservicesEndpoints = properties
                .getGateway()
